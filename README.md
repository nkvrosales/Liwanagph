...
*   **Backend:** PHP (Recommended version 5.6 or newer)
*   **Database:** MySQL
*   **Frontend:** HTML5, Modern CSS (Custom), JavaScript/jQuery
...
*Developed by Lakshmi Narayana | Enhanced & Modernized by Antigravity User*
